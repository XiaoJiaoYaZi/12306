class TicketDetails(object):
    ...
    @property
    def queryseat(self):
        return self._queryseat
    @queryseat.setter
    def queryseat(self,value):
        self._queryseat = value

    @property
    def PassengerForm(self):
        return self._ticketInfoForPassengerForm
    @PassengerForm.setter
    def PassengerForm(self,value):
        self._ticketInfoForPassengerForm = value

    @property
    def reSubmitTk(self):
        return self._reSubmitTk
    @reSubmitTk.setter
    def reSubmitTk(self,value):
        self._reSubmitTk = value
